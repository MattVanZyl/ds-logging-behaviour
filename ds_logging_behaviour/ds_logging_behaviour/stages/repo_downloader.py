    ...
    def operate(self, state, config):
        ...
        for repo_name in repositories.keys():
            ...
            try:
                ...
                logging.info(f" {repo_count}. {PrintColours.BLUE}{repo_name}{PrintColours.RESET} - {PrintColours.YELLOW}Already downloaded{PrintColours.RESET}")
                ...
                try:
                    ...
                    RepositoryMining(repositories[repo_name]['url'],from_commit=repositories[repo_name]['commit'])._clone_remote_repo(tmp_folder=download_folder,repo=repositories[repo_name]['url'])
